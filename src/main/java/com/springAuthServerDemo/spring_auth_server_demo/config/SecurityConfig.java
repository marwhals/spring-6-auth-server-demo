...
public class SecurityConfig {
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        // Form login handles the redirect to the login page from the authorisation server filter chain
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .clientSecret("{noop}secret") // Should really encrypt
        ...
        return new InMemoryRegisteredClientRepository(registeredClient); //Use in memory, JDBC support is available
    }
